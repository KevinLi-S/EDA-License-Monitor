...
async def get_feature_usage(
    ...
    rows = await get_feature_usage_aggregates(session, server_id=server_id, limit=limit)
    return [
        FeatureUsageAggregateSummary(
...
async def get_user_ranking(
    ...
    rows = await get_user_usage_ranking(session, server_id=server_id, limit=limit)
    return [
        UserUsageRankingSummary(
